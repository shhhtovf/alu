...
elseif MyLevel > 700 and OldWorld == true then
	if game.Players.LocalPlayer.Backpack:FindFirstChild("Saber") then
	getgenv().Setting = {
		["Join Team"] = "Pirate", -- "Pirate","Marine"
...
elseif MyLevel > 700 and MyLevel < 1500 and NewWorld == true then
	getgenv().Setting = {
		["Join Team"] = "Pirate", -- "Pirate","Marine"
		["Auto Farm Level"] = true,
		["Fast Farm Level"] = true,
	...
	elseif MyLevel > 1500 and NewWorld == true then
		getgenv().Setting = {
			["Join Team"] = "Pirate", -- "Pirate","Marine"
			["Auto Farm Level"] = false,
			["Fast Farm Level"] = true,
		...
		elseif MyLevel > 1500 and ThreeWorld == true then
			getgenv().Setting = {
				["Join Team"] = "Pirate", -- "Pirate","Marine"
				["Auto Farm Level"] = true,
				["Fast Farm Level"] = true,
